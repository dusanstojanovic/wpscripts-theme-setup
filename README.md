...
7. Search for `name="text_domain" type="array" value="_s"` _within_ the `phpcs.xml.dist` file and replace with `name="text_domain" type="array" value="megatherium-is-awesome"`.
